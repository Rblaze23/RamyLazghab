...
\vspace{1.2mm}
LLMs $\bullet$ IA agentique $\bullet$ RAG $\bullet$ Syst\`emes ML en production
...
\item Conception d'un benchmark de r\'ef\'erence (5 produits, 203 champs de v\'erit\'e terrain) utilis\'e comme boucle de correction sur trois versions : \textbf{affirmations non sourc\'ees r\'eduites de 87,5\,\% \`a 35,0\,\%, F1 port\'e de 81,8 \`a 89,5, pour 0,13\,\$ par dossier}.
\item \textbf{Magnet (radar r\'eglementaire) :} cascade de recherche \`a cinq niveaux (SQL d'abord, LLM en dernier recours), rapports sourc\'es en trois passes. \'Evalu\'e sur 35 rapports g\'en\'er\'es \`a \textbf{88,6\,\% de tra\c{c}abilit\'e des sources} ; 75 tests de s\'ecurit\'e API.
\end{itemize}

\vspace{1.8mm}
\jobtitle{D\'eveloppeur logiciel, stage}{F\'evr. -- Juin 2024}{Infinity Management}\\[2pt]
Plateforme e-learning utilisant le NLP et une analyse de sentiment bas\'ee sur BERT ; back-end Django REST, front-end React, Docker.
...
\item \textbf{RAGenius :} assistant de recherche IA r\'epondant \`a des questions sur PDF et CSV par recherche s\'emantique. \textit{LangChain, Hugging Face, FAISS}

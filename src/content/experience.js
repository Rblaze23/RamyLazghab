...
const experience = [
  ...
  },
  {
    ...
    problem:
      'Regulatory compliance dossiers are slow, manual document work. Someone reads scattered customer-supplied material, extracts what matters, and rewrites it into a fixed, auditable structure — repeatedly, for every product. It is expensive, and it is exactly the kind of work where a small oversight surfaces later in an audit.',
    role: [
      ...
      'Because the output is a compliance artifact rather than a draft, generation on its own is not sufficient — plausible is not the same as correct. So the system also runs validation agents that check what was produced, and sits behind a human review workflow where a reviewer can accept or regenerate any individual part of the document instead of discarding the whole thing and starting again.',
